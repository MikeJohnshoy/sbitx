...
#define CESSB_AUDIO_PEAK_LIMIT (0.9f * SBITX_AUDIO_PEAK_NORM)   // Stage 1 peak limit (pre-Hilbert)
#define CESSB_AUDIO_PRE_FC     4000.0f                          // Stage 1 LPF cutoff (~4 kHz)
#define CESSB_RF_CLIP_LEVEL    (1.05f * SBITX_AUDIO_PEAK_NORM)  // Stage 2 complex-envelope clip
...
#define CESSB_OUTPUT_GUARD (0.99f * SBITX_AUDIO_PEAK_NORM)      // final soft-clip guard threshold
