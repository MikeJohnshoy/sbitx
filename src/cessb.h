...
// CESSB Parameters
#define CESSB_PRE_GAIN 15.0f            // allow float values to get up over 1.0f
                                        // (experimentally determined on sBitx)
#define CESSB_CLIP_LEVEL 0.80f          // hard-clip threshold
#define CESSB_ENVELOPE_LIMIT 0.95f       // final envelope limit
